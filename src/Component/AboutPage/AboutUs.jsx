        ...
        <Row className="about_build">
          <Col xs={12} md={12} lg={6}>
            <div className="title_wraper">
              ...
              <img
                src={BroderLine}
                className="subtitleBorderLineImage"
                alt="subtitleBorderLineImage"
              />
              <h2 className="title">Building A XYZ Place</h2>
              <p>
                Dignity, Opportunity, Hope Building A Prosperous Rural Africa
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Perferendis totam, laudantium officia praesentium expedita omnis
                unde tempora beatae, modi, sequi quis. Est quas corporis, nobis
                aperiam cumque minima libero rem, itaque quo vitae odit?
              </p>
          ...
          <Col xs={12} md={12} lg={6}>
            <div className="build_video_thumbile_image youtbe_video">
              <a
                href="https://www.youtube.com/embed/TwwmhcGbvt0"
                target="_blank"
              >
                {" "}
          ...
          <Col xs={12} md={12} lg={6}>
            <div className="who_we_are">
              ...
              <p className="description">
                ...
                consequuntur delectus iusto inventore tempora iure placeat
                recusandae nobis aliquam itaque.
              </p>
