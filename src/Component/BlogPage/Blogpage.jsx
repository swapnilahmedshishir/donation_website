      ...
      <div>
        ...
        <Container>
            <Row className='blog_catagoray'>
                <Col xs={12} md={11} lg={4}><h4>{displayText}</h4></Col>
                <Col xs={12} md={11} lg={8}>
                <Link to=''><button className='btn_blog_catagory' onClick={handleButtonClick}>Health care</button></Link>
                <button className='btn_blog_catagory small' onClick={handleButtonClick}>Humanitarian</button>
                <button className='btn_blog_catagory small'onClick={handleButtonClick}>Clean water</button>
                <button className='btn_blog_catagory small' onClick={handleButtonClick}>News</button>
                </Col>
            </Row>
        </Container>
       <Container>
