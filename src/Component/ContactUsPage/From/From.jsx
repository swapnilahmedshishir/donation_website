...
const From = () => {
  ...
  <div className="form-group col-md-11 from_text">
    ...
    <textarea className="form-control" name='message' id="exampleFormControlTextarea1" onChange={formik.handleChange} required rows="3" placeholder='Please type your message here...' value={formik.values.message}></textarea>
  </div>
  </div>
  ...
  <button type="submit" className="btn btn_main message_btn">Submit Message</button>
</form>
