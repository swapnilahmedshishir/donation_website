...
import heroImage from './HomeImage/childhoodPhoto2.png';
    ...
    <div>
      <div style={myStyle} className='hero_section'>
        <Container className=''>
            ...
            <h1>HELP TO REBUILD WORLD</h1>
            <p className='hero_para_text'>Empowering global communities during adversity, we ensure safety, health, and access to essentials, while driving economic and infrastructural revitalization for a transformative and sustainable future.</p>
            <Link to='/donate'><button className='btn_main '>Donate now</button></Link>
            <Link to='/about'><button className='btn_about_charity'>About our charity</button></Link>            
            </Col>
            </Row>            
        </Container>        
      </div>
      ...
      <div className='our_project'>
        <Container>
          <Row gx={3} className='project_area'>
            ...
            <h4 className='project_para_text'>Our initiatives focus on assisting people worldwide, ensuring their survival in a rapidly changing world.</h4>
            </Col>
            <Col xs={12} md={12} lg={3}><Link to='/donate'><button className='btn_main project_btn'>Our Projects</button></Link></Col>
          </Row>
          <Project></Project>
        </Container>
      </div>
